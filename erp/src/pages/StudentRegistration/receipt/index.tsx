...
import { FeeAction, FeeFooter, ReceiptLogo, ReceiptLogoWrapper, Subtitle } from './subcomponent'
    ...
    return (
        <PageWrapper>
            ...
            <FeeAction
                ...
                handleFatherName={selectedStudentDetails?.fatherName}
                handleMobileNo={selectedStudentDetails?.mobileNumber}
            />
            <TableWrapper>
